                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      ...
                      <span className="text-gray-700">{car.created_at ? new Date(car.created_at).toLocaleDateString() : 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                    ...
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      ...
                      <span className="text-gray-700">{getMileageDisplay(car)}</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      <span className="font-medium text-gray-600">Transmission</span>
                      <span className="text-gray-700">{car.transmission || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      <span className="font-medium text-gray-600">Body type</span>
                      <span className="text-gray-700">{car.category || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      <span className="font-medium text-gray-600">Fuel</span>
                      <span className="text-gray-700">{car.fuel_type || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      <span className="font-medium text-gray-600">Chassis Number</span>
                      <span className="text-gray-700">{car.chassis_number || 'Not specified'}</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      ...
                      <span className="text-gray-700">{car.color || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      <span className="font-medium text-gray-600">Seats</span>
                      <span className="text-gray-700">{car.specifications?.seating || 'Not specified'}</span>
                    </div>

                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      <span className="font-medium text-gray-600">Emission class</span>
                      <span className="text-gray-700">Euro6d</span>
                    </div>
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                    ...
                    <div className="flex justify-between py-4 border-b border-primary-light/20">
                      ...
                      <span className="text-gray-700">After the first owner, Service book</span>
                    </div>
                  </div>
                </div>
              </div>
